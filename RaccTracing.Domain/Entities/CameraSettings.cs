...
public class CameraSettings(
    ...
    Vec3 vUp)
{
    public CameraSettings() : this(0, 0.0, 1,1, 90,new Point3(0, 0, 0), new Point3(0, 0, -1), new Vec3(0, 1, 0))
    {
    }
    ...
    public double ViewportHeight => 2.0 * h*FocalLength;
    ...
    public Vec3 ViewportUpperLeft => LookFrom - (FocalLength *W) - ViewportU/2 - ViewportV/2;
